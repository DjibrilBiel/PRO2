...
public:
  ...
  class iterator {
    ...
    private:
      ...
      bool is_active_dodge;
      iterator *active_dodge;
      
  
      public:
      
    iterator() {
      is_active_dodge = false;
      active_dodge = NULL;
    }
       ...
       el resultat és el p.i. */
    {
      ...
      pitem = pitem->next;
      if (is_active_dodge and pitem == active_dodge->pitem and pitem != &(plist->itemsup))
        pitem = pitem->next;
      return *this;
    }
       ...
       el resultat és el p.i. */
    {
      ...
      pitem = pitem->prev;
      if (is_active_dodge and pitem == active_dodge->pitem and pitem != plist->iteminf.next)
        pitem = pitem->prev;
      return *this;
    }
